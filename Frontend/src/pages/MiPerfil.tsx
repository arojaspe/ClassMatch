...
export default function MiPerfil() {
  ...
  return (
    <div className="flex w-full h-screen bg-mainClassMatch pt-28 pb-20 p-16 flex-col sm:flex-row max-sm:h-auto min-h-screen mt-10 mb-10">
  {/* Menú lateral */}
  <div className="w-full sm:w-1/4 bg-backgroundClassMatch p-8 rounded-tl-xl sm:rounded-l-xl flex flex-col justify-center max-sm:rounded-tr-xl">
    <h2 className="text-3xl font-KhandBold mb-6 text-headClassMatch text-center sm:text-left">
      Configuración
    </h2>
    <ul className="space-y-4">
      {["Cuenta", "Soporte"].map((item) => (
        <li
          key={item}
          className={`font-KhandSemiBold text-black cursor-pointer p-2 rounded text-xl ${seccionActiva === item ? "bg-gray-400" : ""}`}
  ...
  {/* Contenido principal */}
  <div className="w-full sm:w-3/4 bg-accentClassMatch p-6 rounded-br-xl sm:rounded-r-xl shadow-md flex flex-col justify-center max-sm:rounded-bl-xl">
