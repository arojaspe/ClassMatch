...
export const VerifyEmail = ({ magicLink }: RaycastMagicLinkEmailProps) => (
  <Html>
    <Head />
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={footer}>
          ...
          <Link href="mailto:team@classmatch.site">support@classmatch.com</Link>
        </Text>
      </Container>
    </Body>
  </Html>
...
const container = {
  ...
  backgroundImage:
    'url("https://img.freepik.com/free-photo/vivid-blurred-colorful-wallpaper-background_58702-3883.jpg?w=360")', // Background image URL
